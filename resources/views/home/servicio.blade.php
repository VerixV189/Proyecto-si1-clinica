          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="home/acercaDe"> Sobre Nosotros </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="home/servicio"> Sevicios </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="home/contacto">Contactanos</a>
                </li>
              </ul>
    ...
    <div class="footer_contact">
      ...
      <div class="box">
        <a href="" class="img-box">
          <img src="img/location.png" alt="" class="img-1">
          <img src="img/location-o.png" alt="" class="img-2">
        </a>
        <a href="" class="img-box">
          <img src="img/call.png" alt="" class="img-1">
          <img src="img/call-o.png" alt="" class="img-2">
        </a>
        <a href="" class="img-box">
